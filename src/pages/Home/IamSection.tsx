...
import githubIcon from "../../assets/icon/nav-icon4.svg"
    ...
    return (
        <div className={`flex justify-center items-center flex-wrap ${className}`}>
            <div className="basis-full lg:basis-1/2 flex flex-col gap-6 px-6 md:pl-16 md:pr-6 lg:pl-28 py-10">
                <div>
                    <div>
                        <h1 className="w-full text-4xl font-bold font-sans dark:text-primary">Welcome! </h1>
                        <h1 className="w-full text-3xl font-bold font-sans dark:text-primary">I'm César Uriarte</h1>
                    </div>
                ...
                <div className="flex gap-4">
                    ...
                    <IconSocial href="https://github.com/cesarujos2" src={githubIcon} alt="Instagram Icon" color="#000" />
                </div>
                <div className="flex justify-center mt-1">
                    <Link to={'/contact'}>
                        <div
                            ...
                            <div className="text-2sm font-sans text-white dark:text-black dark:font-semibold">Let's connect</div>
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={theme === "dark" ? "black" : "white" }><path d="m480-320 160-160-160-160-56 56 64 64H320v80h168l-64 64 56 56Zm0 240q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z" /></svg>
                        </div>
                    </Link>
                </div>
            </div>
            <div className="basis-full md:basis-1/2">
                <img style={{ margin: '0 auto', width: '80%', maxWidth: '600px', transform: 'scaleX(-1)', maskImage: 'linear-gradient(black 50%, transparent)' }} src={portrait} alt="Foto" />
            </div>
        </div>
    )
}
